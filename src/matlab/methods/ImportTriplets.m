function [] = ImportTriplets(queryParams)
% ImportTriplets prepares triplet .mat files using database info and a
% queryCondition search criterion
%
%   Usage:
%   queryParams = {{'hands', false}, 618};
%   ImportTriplets(queryParams);
%
%   ImportTriplets(); %imports the entire selected DB
